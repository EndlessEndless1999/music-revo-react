...
export default function CardContainer() {
    return(
        <div className="card-container">
            <Card title='Isnt Anything' image='card-img' html='isnt-white'>
                <DropCard 
            ...
            <Card title='Loveless' image='card-img-loveless' html='loveless-red'>
                <DropCard
            ...
            <Card title='Eps' image='card-img-eps' html='ep-blue'>
                <DropCard 
